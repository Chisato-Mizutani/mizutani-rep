Public Class Form_companion
    ...
    End Sub
    Private Sub Label_empnum_Click(sender As Object, e As EventArgs)

    End Sub
    Private Sub TextBox_empnum_TextChanged(sender As Object, e As EventArgs)

    End Sub
    Private Sub Label_nowdate_Click(sender As Object, e As EventArgs)

    End Sub
    Private Sub Label_lastupdate_Click(sender As Object, e As EventArgs)
    ...
    End Sub
    Private Sub TextBox_Company_TextChanged(sender As Object, e As EventArgs)

    End Sub
    Private Sub Label_company_Click(sender As Object, e As EventArgs)

    End Sub
    Private Sub TextBox_retire_TextChanged(sender As Object, e As EventArgs)

    End Sub
    Private Sub TextBox_address1_TextChanged(sender As Object, e As EventArgs)

    End Sub
    Private Sub TextBox_joindate_TextChanged(sender As Object, e As EventArgs)

    End Sub
    Private Sub Label_joindate_Click(sender As Object, e As EventArgs)

    End Sub
    Private Sub TextBox_belong_TextChanged(sender As Object, e As EventArgs)

    End Sub
    Private Sub Label_belong_Click(sender As Object, e As EventArgs)

    End Sub
    Private Sub Label_retire_Click(sender As Object, e As EventArgs)
    ...
    End Sub
    Private Sub GroupBox_dependents_Enter(sender As Object, e As EventArgs)
